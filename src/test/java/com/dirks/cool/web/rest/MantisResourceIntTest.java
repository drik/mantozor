...
public class MantisResourceIntTest {
    ...
    private static final State DEFAULT_STATE = State.ACCEPTED;
    private static final State UPDATED_STATE = State.ANALYSED;
    ...
    public void createMantis() throws Exception {
        ...
        assertThat(testMantis.getNumber()).isEqualTo(DEFAULT_NUMBER);
        assertThat(testMantis.getState()).isEqualTo(DEFAULT_STATE);
    ...
    public void updateMantis() throws Exception {
        ...
        Mantis testMantis = mantisList.get(mantisList.size() - 1);
        assertThat(testMantis.getNumber()).isEqualTo(UPDATED_NUMBER);
        assertThat(testMantis.getState()).isEqualTo(UPDATED_STATE);
