...
@Service
@Transactional
public class MantisApproverServiceImpl implements MantisApproverService {

    private final Logger log = LoggerFactory.getLogger(MantisApproverServiceImpl.class);

    private final MantisApproverRepository mantisApproverRepository;

    private final MantisApproverMapper mantisApproverMapper;

    public MantisApproverServiceImpl(MantisApproverRepository mantisApproverRepository, MantisApproverMapper mantisApproverMapper) {
