...
public class MantisResource {
    ...
    @GetMapping("/mantis")
    @Timed
    public ResponseEntity<List<MantisDTO>> getAllMantis(Pageable pageable) {
        log.debug("REST request to get a page of Mantis");
        Page<MantisDTO> page = mantisService.findAll(pageable);
