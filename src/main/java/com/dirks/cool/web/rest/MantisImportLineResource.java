...
public class MantisImportLineResource {
    ...
    @Timed
    public ResponseEntity<List<MantisImportLineDTO>> getAllMantisImportLines(MantisImportLineCriteria criteria, Pageable pageable) {
        log.debug("REST request to get MantisImportLines by criteria: {}", criteria);
        Page<MantisImportLineDTO> page = mantisImportLineQueryService.findByCriteria(criteria, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/mantis-import-lines");
