...
export class ProjectDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.referentService.query()
            .subscribe((res: HttpResponse<Referent[]>) => { this.referents = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    trackReferentById(index: number, item: Referent) {
        return item.id;
    }
}
